					...
					<div className="cover shadow-lg bg-white">
						...
						<div className="about-section pt-4 px-3 px-lg-4 mt-1">
							<div className="row">
								<div className="col-md-6">
									...
									<p>
										Hola!, soy Kevin VIllacreses, tengo 27 años. <br /> Desde
										los 13 me dediqué al diseño gráfico, ahora aplico mis
										conocimientos para complementarlo, en Desarrollo Web y de
										Aplicaciones.
									</p>
								</div>
						...
						<div className="work-experience-section px-3 px-lg-4">
							...
							<div className="timeline">
								<ExpCards
									color="primary"
									job="Contratista"
									company="Tejido Arquitectónico - Eco Domotic Home"
									time="02/2022 - Actual"
									content="Tareas realizadas: -Proyectos arquitectónicos -Supervisión de obra -Publicidad e imagen corportiva -Presupuestos y proformas -Seguridad Electrónica -Control de accesos -Sistemas integrales de seguridad"
								/>
								<ExpCards
									color="primary"
									job="Dieñador Gráfico"
									company="Esparta Agencia Creativa"
									time="06/2019 - 09/2021"
									content="Tareas realizadas: -Publicidad, flyers, carteles, tarjetas de presentación -Imagen corporativa para empresas -Empaques de productos -Diseño y host de paginas Web en Wordpress"
								/>
								<ExpCards
									color="primary"
									job="Dibujo de Planos Arquitectónicos"
									company="Arq. Iván Cilio CONSTRUCTORES"
									time="05/2019 - 03/2020"
									content="Tareas realizadas: -Dibujo digital de proyectos 2D y 3D en AutoCAD y ArchiCAD. -Levantamientos arquitectónicos -Proyectos y cotizaciones"
								/>
								<ExpCards
									color="primary"
									job="Marketing y Publicidad"
									company="INALPAC"
									time="08/2018 - 05/2019"
									content="Tareas realizadas: -Imagen corporativa -Nuevos Productos -Manejo de redes sociales -Estudios de Mercado -Proyectos de marketing digitales"
								/>
								<ExpCards
									color="primary"
									job="Líder Regional de equipo, Asistente del presidente (Voluntariado)"
									company="Organización Mundial de Apoyo a la Familia y al Individuo ABIJSUD Brasil."
									time=" 11/2014 - 10/2016 (Porto Alegre - Brasil)"
									content="Tareas realizadas: -Charlas motivacionales para grupos medianos. -Entrenamiento de líderes y voluntarios. -Especialista en planificación estratégica con metas de corto, medio y largo plazo. -Rendición de cuentas regionales con reportes detallados."
								/>
								...
								>
									<input
										...
										type="text"
										required
										placeholder="Ingrese el puesto que desempeñó (Gerente General)"
										value={job}
									...
									<input
										...
										type="text"
										required
										placeholder="Ingrese la empresa en la cual trabajó (Nestlé)"
										value={company}
									...
									<input
										...
										type="text"
										required
										placeholder="Ingrese el rango de tiempo que se desempeñó en el empleo (12/2003 - 02/2005)"
										value={time}
									...
									<input
										...
										type="text"
										required
										placeholder="Ingrese las tareas que realizó (Tareas realizadas: -Gestión y dirección de la empresa, -Proyección de crecimiento, ...)"
										value={content}
						...
						<div className="education-section px-3 px-lg-4 pb-4">
							...
							<div className="timeline">
								<ExpCards
									color="success"
									job="Técnico en Desarrollo Full Stack"
								...
								<ExpCards
									color="success"
									job="Introducción a Ciberseguridad"
								...
								<ExpCards
									color="success"
									job=" Inglés Nivel Avanzado II"
									company="Universidad Politécnica Nacional (CEC)"
									time="2017"
									content=""
								/>
								<ExpCards
									color="success"
									job="Bachillerato General Unificado"
									company="Colegio Menor Universidad Central"
									time="2013"
									content=""
								/>
								...
								>
									<input
										...
										type="text"
										required
										placeholder="Ingrese el título, curso, o formación (Ing. Desarrollo de Software)"
										value={jobS}
									...
									<input
										...
										type="text"
										required
										placeholder="Ingrese la institución educativa en la cual se formó (Harvard)"
										value={companyS}
									...
									<input
										...
										type="text"
										required
										placeholder="Ingrese el año de culminación de los estudios (2019)"
										value={timeS}
									...
									<input
										className="form-control mt-2"
										type="text"
										placeholder="Ingrese información adicional si es necesario (opcional)"
										value={contentS}
